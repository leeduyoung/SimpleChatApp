...
var appId = 'ECE11FF9-F12F-4D4E-8AAD-46A8B9EC7698';
...
$('#guide_create').click(function() {
  ...
  var userDB = '{ "users" : [' +
'{ "id":"leeduyoung", "email":"leeduyoung2002@gmail.com"},' +
'{ "id":"ldy", "email":"ldy@naver.com"},' +
'{ "id":"valve89", "email":"valve89@gmail.com"} ]}';
...
//      $('#btn_messaging_chat2').click(function() {
//        popupInit();
//        $('.modal-guide-create').hide();
//        $('.left-nav-button-guide').hide();
//        $('.modal-open-chat').hide();
...
//  $('#btn_messaging_chat3').click(function() {
//    popupInit();
//    $('.modal-guide-create').hide();
//    $('.left-nav-button-guide').hide();
//    $('.modal-open-chat').hide();
...
//      $('#btn_messaging_chat4').click(function() {
//          popupInit();
//          $('.modal-guide-create').hide();
//          $('.left-nav-button-guide').hide();
//          $('.modal-open-chat').hide();
...
//            console.log(userDB);
//
//            obj = JSON.parse(userDB);
//            console.log(obj.users[0].email);
//            console.log(obj.users[1].email);
//            console.log(obj.users[2].email);
//
//            // getUserList2();
//            // $('.modal-messaging').show(); 
//            // startMessaging3();
...
//  var guestIds = [];
// 
// guestIds.push(chatUser.guest_id); 
//  // guestIds.push(chatUser);
//  // $.each($('.modal-messaging-list__icon--select'), function(index, user) {
//  //   guestIds.push($(user).data("guest-id"));    
//  // });
//
...
//              console.log("qqqq@naver.com");
//
//                var guestIds = [];
//              
//              guestIds.push("qqqq@naver.com"); 
//
//                sendbird.startMessaging(
//                  guestIds,
//                  {
